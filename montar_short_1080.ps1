# ============================================================
# montar_short_1080.ps1 - Homenagem Marlene - Curta 1:30 em 1080p
# ============================================================
...
$OUT     = "$BASE\montagem"
$TEMP    = "$BASE\montagem\temp_short_1080"
...
Write-Host ""
Write-Host "=== Homenagem Marlene - Curta 1:30 em 1080p ===" -ForegroundColor Cyan
Write-Host ""
...
function Make-Text {
    param($id, $linha1, $linha2 = "", $dur = 5, $cor = "white", $tam1 = 108, $tam2 = 72)
    $out = "$TEMP\$id.mp4"
    if (Test-Path $out) { return $out }
...
$segs += Make-Text   "s03_nome"               "MARLENE"                                           ""  3  "white"   126
$segs += Make-Text   "s04_datas"              "20 outubro 1955 - 22 junho 2025"                   ""  4  "#AAAAAA" 51
...
$segs += Make-Text   "s13_frase1"             "Vai dar certo,"                                    ""  3  "white"   93
$segs += Make-Text   "s14_frase2"             "seu fresco!!!"                                     ""  4  "#E8D5A3" 105
$segs += Make-Text   "s15_in_memoriam"        "In memoriam" "Marlene Rodrigues da Conceicao"          5  "#E8D5A3" 72  48
...
$output_final = "$OUT\homenagem_marlene_short_v01_1080p.mp4"
ffmpeg -y `
    -i $video_sem_audio `
    -i $musica_trim `
    -map 0:v -map 1:a `
