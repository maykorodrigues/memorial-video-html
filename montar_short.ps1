# ============================================================
# montar_short.ps1 - Homenagem Marlene - Versao Curta (1:30)
# Foco: Mayko + Marlene | Melhor trecho da musica (2:10 - 3:45)
# ============================================================
...
Write-Host ""
Write-Host "=== Homenagem Marlene - Versao Curta 1:30 ===" -ForegroundColor Cyan
Write-Host ""
...
function Make-Text {
    param($id, $linha1, $linha2 = "", $dur = 5, $cor = "white", $tam1 = 72, $tam2 = 48)
    $out = "$TEMP\$id.mp4"
    if (Test-Path $out) { return $out }
...
$segs += Make-Text   "s03_nome"               "MARLENE"                                           ""  3  "white"   84
$segs += Make-Text   "s04_datas"              "20 outubro 1955 - 22 junho 2025"                   ""  4  "#AAAAAA" 34

# Mayko + Marlene — o coracao do video (26s)
# FOTO ESPECIAL: ela cantando, Mayko na guitarra — igreja
...
# Despedida (16s)
$segs += Make-Text   "s13_frase1"             "Vai dar certo,"                                    ""  3  "white"   62
$segs += Make-Text   "s14_frase2"             "seu fresco!!!"                                     ""  4  "#E8D5A3" 70
$segs += Make-Text   "s15_in_memoriam"        "In memoriam" "Marlene Rodrigues da Conceicao"          5  "#E8D5A3" 48  32
...
# ---------------------------------------------------------------
# MUSICA — trecho 2:10 a ~3:45 (refrao principal)
# "Se Voce Pudesse Me Ouvir" — David Rocha
# ---------------------------------------------------------------
Write-Host "Preparando musica (a partir de 2:10)..." -ForegroundColor Yellow
...
$output_final = "$OUT\homenagem_marlene_short_v01_720p.mp4"
ffmpeg -y `
    -i $video_sem_audio `
    -i $musica_trim `
    -map 0:v -map 1:a `
...
Write-Host ""
Write-Host "Assista com fones, sozinho, com calma." -ForegroundColor Cyan
Write-Host ""
